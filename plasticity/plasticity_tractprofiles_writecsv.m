...
% Set fiber groups
fiberName = {'merge_1_3_lh_mpfc_nacc.mat', ...
             'merge_1_3_rh_mpfc_nacc.mat'};
         
%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['ctr_mpfc_nacc_merge13_tp100',dateAndTime,'.csv']);
...
for i = 1:numel(baseDir)
    ...
    for ii=1:numel(subs)
        ...
        if ~isempty(sub)
            ...
            fiberDir = fullfile(subDir,'dti96trilin/fibers/conTrack/plasticity');
