function [fg, keep] = plasticity_mbaComputeFibersOutliers_SuperFiberFromMergedGroup(fg,mergedFg,maxDist,maxLenStd,numNodes,centralTendency,count,maxIter)
%
...
while cont ==1 && iter<=maxIter
    ...
    mergedFg = fgRead(mergedFg);
    [~, TLmm]  = mbaComputeFiberLengthDistribution(mergedFg, false);
