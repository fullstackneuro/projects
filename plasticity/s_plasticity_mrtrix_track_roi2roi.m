...
switch mode_str
  case {'SD_PROB', 'SD_STREAM'}
   ...
   cmd_str = sprintf('streamtrack -seed %s -mask %s -include %s -include %s %s %s %s -number %d -maxnum %d -stop -minlength 10 -cutoff 0.02 -initcutoff 0.02 -curvature 1 -step 0.2',...
       seed,mask, roi1, roi2, mode_str, files.csd, tck_file, n, n_max);
