...
% Set fiber groups
fiberName = {'clean_lh_ains_nacc.mat', ...
             'clean_rh_ains_nacc.mat', ...
             'clean_lh_mpfc_nacc.mat', ...
             'clean_rh_mpfc_nacc.mat', ...
             'clean_lh_vta_nacc.mat', ...
             'clean_rh_vta_nacc.mat'};
         
%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['plasticity_mpfcvtaainsnacc_tp100_',dateAndTime,'.csv']);
...
for i = 1:numel(baseDir)
    ...
    for ii=1:numel(subs)
        ...
        if ~isempty(sub)
            ...
            fiberDir = fullfile(subDir,'dti96trilin/fibers/conTrack/');
