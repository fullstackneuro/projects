...
%}        
% Set fiber groups
roiName = {'naccROI_unclean_lh_mpfc_nacc.mat', ...
           'naccROI_unclean_lh_vta_nacc.mat', ...
           'naccROI_unclean_rh_mpfc_nacc.mat', ...
           'naccROI_unclean_rh_vta_nacc.mat'};

%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['plastic_tractroi_',dateAndTime,'.csv']);
...
for i = 1:numel(baseDir)
    ...
    for ii=1:numel(subs)
        ...
        if ~isempty(sub)
            ...
            roiDir   = fullfile(subDir,'dti96trilin/fibers/conTrack');
