function fibersPDB = s_plasticity_mrtrix_track_between_rois_OLD
%
...
subjects={'hm082514_hardi1','hm082514_hardi2','hm082514_hardi3', ...
          'hm082514_2_hardi1','hm082514_2_hardi2','hm082514_2_hardi2'};
 %{
...
for isubj = 1:length(subjects)
    ...
    toRois   = {'rh_mpfc_5mm','rh_antshortins_fd','vta_5mm'};
    ...
    % seeding
    wmMaskName = fullfile(baseDir, subjectDir, '/ROIs/rh_wmmask_fs_fd_mpfc5mm');
