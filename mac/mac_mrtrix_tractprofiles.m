...
% Set fiber groups
fiberName = {'clean_lh_anterior.mat', ...
             'clean_lh_motor.mat', ...
             'clean_lh_parietal.mat', ...
             'clean_lh_posterior.mat', ...
             'clean_lh_temporal.mat', ...
             'clean_rh_anterior.mat', ...
             'clean_rh_motor.mat', ...
             'clean_rh_parietal.mat', ...
             'clean_rh_posterior.mat', ...
             'clean_rh_temporal.mat'};
         
%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['mac_mrtrix_thal_tp100',dateAndTime,'.csv']);
...
for i = 1:numel(baseDir)
    ...
    for ii=1:numel(subs)
        ...
        if ~isempty(sub)
            ...
            fiberDir = fullfile(subDir,'dti64trilin/fibers/mrtrix');
