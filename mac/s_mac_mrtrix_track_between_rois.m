function fibersPDB = s_mac_mrtrix_track_between_rois
%
...
%cp FA_R.mat FP_R.mat ILF_roi2_R.mat SLF_roi1_R.mat SLF_roi2_R.mat 
%FA_L.mat FP_L.mat ILF_roi2_L.mat SLF_roi1_L.mat SLF_roi2_L.mat ../../ROIs/.
...
for isubj = 1:length(subjects)
    ...
    fromRois = {'rh_thal_aseg_fd'};
    %rh_thal_aseg_fd
    toRois = {'ILF_roi2_R'};
    %toRois   = {'FA_L','FP_L','ILF_roi2_L','SLF_roi1_L','SLF_roi2_L'};
    %'FA_R','FP_R','ILF_roi2_R','SLF_roi1_R','SLF_roi2_R'
    wmMaskName = fullfile(baseDir, subjectDir, '/ROIs/rh_wmsegthalventdcinfins_fd');
    %rh_wmsegthal_fd
