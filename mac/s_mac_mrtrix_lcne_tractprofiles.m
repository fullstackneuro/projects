...
% Set fiber groups
fiberName = {'outlie_rh_antshortins_nacc.mat' };

%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['mrtrix_vlpfcpresmastn_lcne_tp100_',dateAndTime,'.csv']);
...
for i = 1:numel(baseDir)
    ...
    for ii=1:numel(subs)
        ...
        if ~isempty(sub)
            ...
            dt6Dir   = fullfile(subDir,'dti64trilin');
