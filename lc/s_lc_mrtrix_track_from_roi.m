function fibersPDB = s_lc_mrtrix_track_from_roi
%
...
subjects = {'np072412','pf020113','pl061413','ps151001'};
...
for isubj = 1:length(subjects)
    ...
    for nRoi = 1:length(toRois)
        ...
        [fibersPDB{nRoi}, status, results] = s_lc_mrtrix_track_roi(files, [roi{1} '.mif'],  ...
