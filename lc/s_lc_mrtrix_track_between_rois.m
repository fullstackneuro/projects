function fibersPDB = s_lc_mrtrix_track_between_rois
%
...
subjects = {''};
    %np072412,pf020113,pl061413,ps151001
    %pw060713,pw061113,ra053013,rb073112,rb082212,sd040313,sh010813
    %sl080912,sn061213,sp061313,tr101312,tw062113,vv060313,wb071812  
...
for isubj = 1:length(subjects)
    ...
    fromRois = {'rlc5'};
    toRois   = {'rh_antins_a2009s_rs','rh_shortins_a2009s_rs'};
    wmMaskName = fullfile(baseDir, subjectDir, '/ROIs/rh_wmmask_fs_fd_postins');
    ...
    for nRoi = 1:length(toRois)
        ...
        [fibersPDB{nRoi}, status, results] = s_lc_mrtrix_track_roi2roi(files, [roi{1} '.mif'], [roi{2} '.mif'], ...
