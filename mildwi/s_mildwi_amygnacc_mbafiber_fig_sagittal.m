...
for isubj = 1:length(subjects)
    ...
    hold on
    mbaDisplayBrainSlice(ti,[0 0 -23])

    [fh, lh] = mbaDisplayConnectome(lamyg.fibers,fgh,[0.23, 0.49, 0.63],'single',[],[],0.3);
    delete(lh);
    [fh, lh] = mbaDisplayConnectome(ramyg.fibers,fgh,[0.99,0.71,0.08],'single',[],[],0.3);
    delete(lh);
    view(210,25);
    lh = lightangle(180,26);
    axis([-60 60 -40 70 -23 70]);
    %save fig
    lfigurename = [subjects{isubj} '_amygnacc_cor'];
