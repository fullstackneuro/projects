...
% Set fiber groups
fiberName = {'outlie_rh_antshortins_nacc.mat', 'outlie_lh_antshortins_nacc.mat', ...
             'outlie_lh_ains_vlpfc.mat', 'outlie_rh_ains_vlpfc.mat', ...
             'outlie_lh_vlpfc_stn.mat', 'outlie_rh_vlpfc_stn.mat', ...
             'outlie_lh_presma_stn.mat', 'outlie_rh_presma_stn.mat'};

%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['mrtrix_vlpfcainsnaccpresmastn_plstc_tp100_',dateAndTime,'.csv']);
