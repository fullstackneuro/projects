function a_abcd_csd_phil

baseDir='/mnt/acorn/abcd/matproc/phil';

%produces subject list:
subjects={};
file=fopen(fullfile('/mnt/acorn/abcd/matproc', 'scripts', 'phil_dwi_c.txt'),'r');
tline=fgetl(file);
while ischar(tline)
    %disp(tline);
...
for isubj = 1:length(subjects)
    try
        ...
        dtFile = fullfile(baseDir, subjectDir, '/dti59trilin/dt6.mat');
        fibersFolder  = fullfile(baseDir, subjectDir, '/dti59trilin/fibers/mrtrix/');
        lmax    = [6];
        wmMask = [];
