function fibersPDB = a_abcd_mrtrix_track_ains_nacc
...
subjects = a_abcd_generate_sublists('rawainsnacc');
...
%found by manual inspection. Needs further work.
bad_subs={'NDARINV71N5JHR2'};
...
for isubj = 1:length(subjects)
    ...
    if ~ismember(subjects{isubj},bad_subs)
        ...
        wmMaskFS = '_ains_nacc_mask_merged_fd';       
