function reorient_ainsnacc_fibers(baseDir, sublist)
...
for isubj = 1:length(subjects)
   ...
   try
       ...
       leftFromRoifile = fullfile(roiDir, 'lh_antshortins_fd.mat');
       leftFGfile = fullfile(fiberDir, [subName '_dwi_aligned_trilin_csd_lmax6_lh_nacc_aseg_fd_lh_antshortins_fd_lh_nacc_aseg_fd_nonZero_MaskROI_lh_antshortins_fd_nonZero_MaskROI_union.nii.gz_lh_ains_nacc_nihpd_bin03_fd_cut003_initcut003_curv1_step02_nfibers2000_prob.pdb']);
       ...
       fgWrite(leftFGFlipped, fullfile(fiberDir, 'flip_lh_ains_nacc.mat')); %save out new fibergroup.
   ...
   try
       ...
       rightFromRoifile = fullfile(roiDir, 'rh_antshortins_fd.mat');
       rightFGfile = fullfile(fiberDir, [subName '_dwi_aligned_trilin_csd_lmax6_rh_nacc_aseg_fd_rh_antshortins_fd_rh_nacc_aseg_fd_nonZero_MaskROI_rh_antshortins_fd_nonZero_MaskROI_union.nii.gz_rh_ains_nacc_nihpd_bin03_fd_cut003_initcut003_curv1_step02_nfibers2000_prob.pdb']);
       ...
       fgWrite(rightFGFlipped, fullfile(fiberDir, 'flip_rh_ains_nacc.mat')); %save out new fibergroup.
