function clean_vtanacc_outliers(baseDir, sublist)
...
for isubj = 1:length(subjects)
    ...
    %right hemi
    try
        rh_fg_name = dir([fibersFolder '/' 'flip_rh_vta_nacc.mat']);
        ...
        fgWrite(rh_fg_clean, [fibersFolder '/outlie_rh_vta_nacc'],'mat');
    catch e
        disp(e.identifier);
        disp(e.message);
    end
    ...
    %left hemisphere
    try
        lh_fg_name = dir([fibersFolder '/' 'flip_lh_vta_nacc.mat']);
        ...
        fgWrite(lh_fg_clean, [fibersFolder '/outlie_lh_vta_nacc'],'mat');
    catch e
        disp(e.identifier);
        disp(e.message);
    end
