...
% Set fiber groups
fiberName = {'aligned_trilin_csd_lmax10_lh_amyg_a2009s_lh_nacc_aseg_fd_lh_amyg_a2009s_nonZero_MaskROI_lh_nacc_aseg_fd_nonZero_MaskROI_union_lh_wmmask_amyg_fd_prob.pdb', ...
             'aligned_trilin_csd_lmax10_rh_amyg_a2009s_rh_nacc_aseg_fd_rh_amyg_a2009s_nonZero_MaskROI_rh_nacc_aseg_fd_nonZero_MaskROI_union_rh_wmmask_amyg_fd_prob.pdb'};

%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['mrtrix_unclean_amyg_nacc_fg',dateAndTime,'.csv']);
