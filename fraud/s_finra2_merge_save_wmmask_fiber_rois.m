function s_finra2_merge_save_wmmask_fiber_rois
% merges wmmask roi and fiberRoi, saves as single mat roi
%
%
%
...
for isubj = 1:length(subjects)
    ...
    roi1    = dtiReadRoi(fullfile(roiPath,'rh_wmmask_fs_fd_clip_mpfc.mat'));
    fiberRoi= dir(fullfile(roiPath,['scoredFG_frontostriatal_rh_mpfc' '*' '.mat']));
    roi2    = dtiReadRoi(fullfile(roiPath,fiberRoi.name));
    newRoiName = fullfile(roiPath,'rh_wmmask_fs_fd_clip_mpfc_fiberRoi.mat');
