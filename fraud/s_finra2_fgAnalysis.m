...
% Set fiber groups
fiberName = {'scored_fg_rh_antins_nacc_clean_post_140515.mat','scored_fg_lh_antins_nacc_clean_140505.mat'};

%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['ctr_antins_nacc_fgclean_posterior',dateAndTime,'.txt']);
