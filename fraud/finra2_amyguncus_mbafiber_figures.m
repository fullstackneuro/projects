...
%delete(lh);
[fh, lh] = mbaDisplayConnectome(luncus.fibers,fgh,[1,0.89,0.77],'single',[],[],0.3);
delete(lh);
...
%delete(rlh);
%[rfh, rlh] = mbaDisplayConnectome(runcus.fibers,rfgh,[1,0.89,0.77],'single',[],[],0.3);
%delete(rlh);
[rfh, rlh] = mbaDisplayConnectome(rinsula.fibers,rfgh,[0.7,0.4,0.4],'single',[],[],0.3);
delete(rlh);
[rfh, rlh] = mbaDisplayConnectome(ramyg.fibers,rfgh,[0.4,0.2,0.2],'single',[],[],0.3);
delete(rlh);
