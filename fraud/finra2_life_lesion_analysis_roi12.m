...
for isubj = 1:length(subjects)
    ...
    lifeFolder    = fullfile(subjectFolder, '/dti96trilin/fibers/life/rh_roi12');
    ...
    if length(fasciclesRoi1ToRoi2.fibers) == sum(indicesRoi1ToRoi2)
    ...
    subjectSeName = fullfile(lifeFolder,[subjects{isubj} '_rh_se_roi12.mat']);
