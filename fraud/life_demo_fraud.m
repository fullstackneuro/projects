function [fh, fe] = life_demo_fraud()
...
dwiFile       = '/media/storg/matlab_proc/wb071812_mrdiff/2981_10_1_aligned_trilin.nii.gz';
dwiFileRepeat = '/media/storg/matlab_proc/wb071812_mrdiff/2981_10_1_aligned_trilin_2.nii.gz';
t1File        = '/media/storg/matlab_proc/wb071812_mrdiff/wb071812_t1_acpc.nii.gz';
...
fgFileName    = '/media/storg/matlab_proc/wb071812_mrdiff/dti96trilin/fibers/life/rh_antins_nacc_fgclean.mat';

% The final connectome and data astructure will be saved with this name:
feFileName    = 'life_build_model_wb071812_CSD_PROB';
...
fe = feConnectomeInit(dwiFile,fgFileName,feFileName,[],[],t1File);
