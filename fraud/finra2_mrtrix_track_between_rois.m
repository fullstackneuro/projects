...
subjectDir = '/ch101612_mrdiff/';
dtFile = fullfile(baseDir, subjectDir, '/dti96trilin/dt6.mat');
refImg = fullfile(baseDir, subjectDir, 'ch101612_t1_acpc.nii.gz');
...
toRois   = {'rh_antins_a2009s','rh_gins_a2009s','rh_infins_a2009s','rh_supins_a2009s'};

% Set upt the MRtrix trakign parameters
trackingAlgorithm = {'prob'};
lmax    = [12]; % The appropriate value depends on # of directions. For 32, use lower #'s like 4 or 6. For 70+ dirs, 6 or 10 is good [10];
...
% seeding
wmMaskName = fullfile(baseDir, subjectDir, '/ROIs/wmMask_large_tracking');
