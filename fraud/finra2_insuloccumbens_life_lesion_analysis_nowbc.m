...
for isubj = 1:length(subjects)
    ...
    lifeFolder    = fullfile(subjectFolder, '/dti96trilin/fibers/life/forfigs');
    ...
    clear fit
    feConnectomeSave(fe);
    subjectFeName = fullfile(lifeFolder,[subjects{isubj} '_rh_fe_nowbc.mat']);
    save(subjectFeName, 'fe');
    ...
    subjectSeName = fullfile(lifeFolder,[subjects{isubj} '_rh_se_nowbc_forfigs.mat']);
