function wmMask = s_feMakeWMaskh(classFile,mdFile,wmMaskFileName,prctThr)
% 
...
if notDefined('tissueToUse'), tissueToUse = [0 1 1 1 1];end
...
% diffusivity value.
% rmove anynan
wmMask.data(isnan(wmMask.data)) = false;
