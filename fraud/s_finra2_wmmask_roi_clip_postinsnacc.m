function s_finra2_wmmask_roi_clip_postinsnacc
%
...
for isubj = 1:length(subjects)
    ...
    roi = dir(fullfile(roiPath,'rh_wmmask_ins_fd.mat'));
    oldRoi = roi.name;
    oldRoiPath = fullfile(roiPath, oldRoi);
    outRoi = [roiPath '/rh_wmmask_clip_postinsnacc.mat'];
    ...
    newRoi     = dtiRoiClip(newRoi,[],[],si_coords2);
