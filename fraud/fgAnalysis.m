...
% Group 1
subjects = {'sd040313_mrdiff'};

% Set fiber groups
fiberName = {'4260_10_1_aligned_trilin_csd_lmax12_rh_antins_tal_4mm_rh_nacc_tal_4mm_rh_antins_tal_4mm_nonZero_MaskROI_rh_nacc_tal_4mm_nonZero_MaskROI_union_wmMask_tracking_prob.pdb'};

%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['sd040313_rh_tract',dateAndTime,'.txt']);
...
for i = 1:numel(baseDir)
    ...
    for ii=1:numel(subs)
        ...
        if ~isempty(sub)
            ...
            fiberDir = fullfile(subDir,'dti96trilin/fibers/life');
