function finra2_postinsnacc_life_lesion_analysis
...
for isubj = 1:length(subjects)
    ...
    lifeFolder    = fullfile(subjectFolder, '/dti96trilin/fibers/mrtrix/life/postins/lh_nowbc');
    ...
    sub_roi2roi_track = fullfile(fibersFolder, 'clean_lh_postins_nacc.mat');
       
    % ROIs and WM masks
    roiFolder        = fullfile(baseDir, subjectDir, '/ROIs');
    sub_wmmask_track = fullfile(roiFolder, 'lh_wmmask_clip_postinsnacc.nii.gz');
    
    sub_roi1 = fullfile(roiFolder, 'lh_postins.nii.gz');
