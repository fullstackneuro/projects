...
%load insula tract
mrtrix_wd = '/media/storg/matproc/dp092612/dti96trilin/fibers/mrtrix';
rh_uncleaninsula = dir(fullfile(mrtrix_wd,'*aligned_trilin_csd_lmax10_rh_antshortins_fd_rh_nacc_aseg_fd_rh_antshortins_fd_nonZero_MaskROI_rh_nacc_aseg_fd_nonZero_MaskROI_union_rh_wmmask_fs_fd_clip_prob.pdb'));
rh_insula = fullfile(mrtrix_wd, rh_uncleaninsula.name);
...
%save figure
feSavefig(rfh,'figName','dp092612_rh_insula_unclean','figDir','/media/storg/matproc/figures','figType','jpg')
