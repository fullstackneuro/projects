...
for isubj = 1:length(subjects)
    ...
    dtFile = fullfile(baseDir, subjects{isubj}, '/dti96trilin/dt6.mat');
...
dtFile = fullfile(baseDir, 'uk160917', '/dti96trilin/dt6.mat');
dt6 = load(dtFile,'files');
files = dt6.files;
files.t1 = 'els006_t1_acpc.nii.gz';
files.alignedDwRaw = '/media/lcne/matproc/uk160917/uk160917_aligned_trilin.nii.gz';
files.alignedDwBvecs = '/media/lcne/matproc/uk160917/uk160917_aligned_trilin.bvecs';
files.alignedDwBvals = '/media/lcne/matproc/uk160917/uk160917_aligned_trilin.bvals';
save(dtFile, 'files','-APPEND')
