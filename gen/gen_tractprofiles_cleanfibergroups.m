...
% which fiber groups?
fiberName = {'rh_antshortins_nacc.mat','rh_frontorb_shortins.mat', ...
             'lh_antshortins_nacc.mat','lh_frontorb_shortins.mat'};

%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;

% save data to what file name?
textFileName    = fullfile(logDir,['mrtrix_vlpfcainsnacc_tp100_',dateAndTime,'.csv']);
