function [pdb_file, status, results] = s_gen_mrtrix_track_roi2roi(files, roi1, roi2, seed, mask, mode, n, n_max, cutoff, initcutoff, curvature, stepsize, bkgrnd, verbose)
