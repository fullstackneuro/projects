...
%load t1
ti = niftiRead('/media/storg/matproc/yw083014_7mm/yw083014_7mm_t1_acpc.nii.gz');

%left hemisphere
%load insula tract
mrtrix_wd = '/media/storg/matproc/yw083014_7mm/dti96trilin/fibers/mrtrix';
