...
%}
%load t1
ti = niftiRead('/media/storg/matproc/yw083014_7mm_1/yw083014_7mm_t1_acpc.nii.gz');
%load insula tract
mrtrix_wd = '/media/storg/matproc/yw083014_7mm_1/dti96trilin/fibers/mrtrix';
rh_insula = fullfile(mrtrix_wd,'clean_rh_ainsnacc.mat');
