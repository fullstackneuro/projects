...
fibersDir = 'fibers/conTrack/mesolimbic';
     
subjects = {'lc052213'};
                
% Set fiber groups
fiberName = {'clean_lh_vta_nacc.mat','clean_rh_vta_nacc.mat'};
%'clean_lh_antshortins_nacc.mat','clean_rh_antshortins_nacc.mat'
         
%% Set up the text file that will store the fiber vals.
dateAndTime     = getDateAndTime;
textFileName    = fullfile(logDir,['lc_mrtrix_vtanacc_tp100',dateAndTime,'.csv']);
...
for i = 1:numel(baseDir)
    ...
    for ii=1:numel(subs)
        ...
        if ~isempty(sub)
            ...
            fiberDir = fullfile(subDir,dirs,fibersDir);
