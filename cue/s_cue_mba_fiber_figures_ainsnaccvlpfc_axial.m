...
for isubj = 1:length(subjects)
    ...
    delete(llh);
    [lfh, llh] = mbaDisplayConnectome(rvlpfc.fibers,lfgh,[0.96,0.84,0.6],'single',[],[],0.3);
    delete(llh);
    axis([-60 60 -10 90 -10 80]);
    view(0,90);
    llh = lightangle(180,80);
    %save figure
    feSavefig(lfh,'figName',[subjects{isubj} '_ainsnaccvlpfc_ax_bh'],'figDir',figuresDir,'figType','jpg')
