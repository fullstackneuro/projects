...
for isubj = 1:length(subjects)
    ...
    rh_fg_name = dir([fibersFolder '/*aligned_trilin_csd_lmax10_lh_nacc_aseg_lh_antshortins_fd_lh_nacc_aseg_nonZero_MaskROI_lh_antshortins_fd_nonZero_MaskROI_union_lh_wmmask_fs_fd_cut0075_initcut005_curv1_step02_prob.pdb']);
    ...
    fgWrite(rh_fg_clean, [fibersFolder '/clean_lains_nacc'],'mat');
