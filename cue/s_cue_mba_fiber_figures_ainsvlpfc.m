...
for isubj = 1:length(subjects)
    ...
    delete(llh);
    [lfh, llh] = mbaDisplayConnectome(lvlpfc.fibers,lfgh,[.5,0.19,0.4],'single',[],[],.3);
    delete(llh);
    view(250,10);
    ...
    %save figure
    feSavefig(rfh,'figName',[subjects{isubj} '_ainsvlpfc_sag_rh'],'figDir',figuresDir,'figType','jpg')
