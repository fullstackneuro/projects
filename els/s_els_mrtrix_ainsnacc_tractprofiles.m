...
subjects = {'els006','els009','els013','els014','els016','els017','els024', ...
            ...
            'els202','els203','els208','els210', ...
            'els175','els184','els187','els196','els201','els214','els215'};
...
for i = 1:numel(baseDir)
    ...
    for ii=1:numel(subs)
        sub = fullfile(baseDir{i},subs{ii});
        if ~isempty(sub)
            subDir   = fullfile(sub);
