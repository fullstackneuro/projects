function fibersPDB = s_els_mrtrix_track_vlpfc_shortins
%
...
'els006','els009','els012','els013','els014','els016','els017', ...
            ...
            'els085','els086','els087','els088','els089',
%}
hemis = {'lh','rh'};
...
for isubj = 1:length(subjects)
    ...
    fromRois = '_shortins_a2009s_fd';
    toRois   = {'_frontorb_a2009s_fd'};
    ...
    cutoff = 0.2; %FA cutoff along path
