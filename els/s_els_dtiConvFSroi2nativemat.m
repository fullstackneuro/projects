function s_els_dtiConvFSroi2nativemat
%
...
for isubj = 1:length(subjects)
    ...
    asegFile  = dir(fullfile(matProcPath,'a2009seg2nat.nii.gz'));
    asegFname = asegFile.name;
    asegPath  = fullfile(matProcPath, asegFname);

    %create mat rois based on fs seg lookup table
    dtiConvertFreeSurferRoiToMat(asegPath, 26, 'lh_nacc_aseg2nat');
    dtiConvertFreeSurferRoiToMat(asegPath, 58, 'rh_nacc_aseg2nat');
    %{
