function s_els_dtiInit_across_subjects_tkmid4
%
...
subjects = {'els214-Tmid','els302-TK1','els303-TK1'};
%{
'els055-Tmid','els137-Tmid','els144-Tmid','els145-Tmid','els146-Tmid','els152-Tmid',
'els159x-Tmid','els172-Tmid','els192-Tmid','els214-Tmid','els302-TK1','els303-TK1',
'els305-TK1','els307x-TK1','els311-TK1',
'els312-TK1','els315-TK1','els318-TK1'}
%}

55, 137, 144, 145, 146, 152, 159x (dti), 172, 214, 
