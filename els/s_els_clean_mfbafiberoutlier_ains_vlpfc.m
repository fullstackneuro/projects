function s_els_clean_mfbafiberoutlier_ains_vlpfc
...
for isubj = 1:length(subjects)
    ...
    %right hemi
    rh_fg_name = dir([fibersFolder '/' subjects{isubj} '_aligned_trilin_csd_lmax8_rh_shortins_a2009s_fd_rh_frontorb_a2009s_fd_rh_shortins_a2009s_fd_nonZero_MaskROI_rh_frontorb_a2009s_fd_nonZero_MaskROI_union_rh_wmmask_fs_fd_cut02_initcut01_curv1_step02_prob.pdb']);
    ...
    fgWrite(rh_fg_clean, [fibersFolder '/clean_rh_ains_vlpfc'],'mat');

    %left hemisphere
    lh_fg_name = dir([fibersFolder '/' subjects{isubj} '_aligned_trilin_csd_lmax8_lh_shortins_a2009s_fd_lh_frontorb_a2009s_fd_lh_shortins_a2009s_fd_nonZero_MaskROI_lh_frontorb_a2009s_fd_nonZero_MaskROI_union_lh_wmmask_fs_fd_cut02_initcut01_curv1_step02_prob.pdb']);
    ...
    fgWrite(lh_fg_clean, [fibersFolder '/clean_lh_ains_vlpfc'],'mat');
end