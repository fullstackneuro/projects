function [pdb_file, status, results] = s_vlpfc_mrtrix_track_roi2roi(files, roi1, roi2, seed, mask, mode, n, n_max, cutoff, initcutoff, curvature, stepsize, bkgrnd, verbose)
...
tck_file = strcat(strip_ext(files.csd), '_', strip_ext(roi1), '_', strip_ext(roi2), '_', ...
                            strip_ext(seed) , '_', strip_ext(mask), '_', 'default','_',mode, '.tck'); 
