function s_vlpfc_clean_mfbafiberoutlier_latorbcaudate
...
for isubj = 1:length(subjects)
    ...
    rh_fg_name = dir([fibersFolder '/*aligned_trilin_csd_lmax10_rh_caud_aseg_rh_latorb_a2009s_fd_rh_caud_aseg_nonZero_MaskROI_rh_latorb_a2009s_fd_nonZero_MaskROI_union_rh_wmmask_vlpfc_fd_default_prob.pdb']);
    ...
    fgWrite(rh_fg_clean, [fibersFolder '/clean_rlatorbcaudate_default'],'mat');
