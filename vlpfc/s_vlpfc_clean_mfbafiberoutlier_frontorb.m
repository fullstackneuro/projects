function s_vlpfc_clean_mfbafiberoutlier_frontorb
...
for isubj = 1:length(subjects)
    ...
    rh_fg_name = dir([fibersFolder '/*aligned_trilin_csd_lmax10_rh_frontorb_a2009s_rh_shortins_a2009s_rh_frontorb_a2009s_nonZero_MaskROI_rh_shortins_a2009s_nonZero_MaskROI_union_rh_wmmask_vlpfc_fd_default_prob.pdb']);
    ...
    fgWrite(rh_fg_clean, [fibersFolder '/clean_rfrontorbshortins_default'],'mat');
