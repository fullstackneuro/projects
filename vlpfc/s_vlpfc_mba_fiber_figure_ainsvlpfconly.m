...
subjects = {'ab071412','dc050213','ds080712','en062813','gr051513','hm062513', ...
            'jw072512','lc052213','lw061713','ml061013','mn052313','ms082112', ...
            'np072412','pl061413','pw060713','sl080912','sn061213','sp061313', ...
            'vv060313','wb071812'};
%{
...
for isubj = 1:length(subjects)
    ...
    rVlpfcFile = fullfile(mrtrixDir, 'clean_rfrontorbshortins_default.mat');
    ...
    %save figure
    feSavefig(rfh,'figName',[subjects{isubj} '_rh_ainsvlpfc'],'figDir',figuresDir,'figType','jpg')
end