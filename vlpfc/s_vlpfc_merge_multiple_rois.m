function s_vlpfc_merge_multiple_rois
...
for isubj = 1:length(subjects)
    ...
    roi2    = dtiReadRoi(fullfile(roiPath,'lh_antshortins_fd.mat'));
    roi3    = dtiReadRoi(fullfile(roiPath,'lh_frontinfang_a2009s_fd.mat'));
    roi4    = dtiReadRoi(fullfile(roiPath,'lh_frontorb_a2009s_fd.mat'));
    roi5    = dtiReadRoi(fullfile(roiPath,'lh_latorb_a2009s_fd.mat'));
    ...
    finalRoi = dtiMergeROIs(newRoi3, roi5);
