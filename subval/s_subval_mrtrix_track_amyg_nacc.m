function fibersPDB = s_subval_mrtrix_track_amyg_nacc
%
...
%{
done 'SV_002','SV_003','SV_005','SV_007','SV_015','SV_016', ...
...
%}
%brainmask SV_009 SV032 SV_163
            
for isubj = 1:length(subjects)

    subjectDir    = [subjects{isubj}];
    subjectRefImg = [subjects{isubj} '_t1_acpc.nii.gz'];
    dtFile = fullfile(baseDir, subjectDir, '/dti32trilin/dt6.mat');
